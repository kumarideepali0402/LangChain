...
class Review(BaseModel):
    key_themes: list[str] = Field(description ="give key themes in the form of list")
    summary: str= Field(description ="brief summary of review")
    sentiment: Literal["pos", "neg"]= Field(description ="Sentiment of reviewr")
    pros: Optional[list[str]] = Field(description = "pros of review")
